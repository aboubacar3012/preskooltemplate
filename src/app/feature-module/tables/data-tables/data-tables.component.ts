...
import { DataService, defaultData } from "src/app/core/core.index";
...
export class DataTablesComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.defaultData.map((res: defaultData, index: number) => {
    ...
    this.totalData = this.data.defaultData.length;
