...
export class TimetableMainComponent implements OnInit {
  ...
  dataSource!: MatTableDataSource<timetabledata>;
  ...
  private getTableData(): void {
    ...
    this.data.timeTable.map((res: timetabledata, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<timetabledata>(this.lstTimetable);
  ...
  public sortData(sort: Sort) {
    ...
    if (!sort.active || sort.direction === '') {
      ...
      this.lstTimetable = data.sort((a, b) => {
